...
<?php 
    		...
    		$sql = "INSERT INTO result_cards(to_user,format,url,from_user) VALUES('$to_user','$format','$fileUrl','$from_user')";
    		// echo $sql;
    		$query = mysqli_query($conn, $sql);
    		if($query){
...
<body>
  ...
  <div class="text-center">
	...
	<h5 id="typing" class="text-center text-info font-50px aniview-2 slow" data-av-animation="pulse">
		<span class="border-bottom-info">New Result Card</span>&nbsp;
	</h5>
