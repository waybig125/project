(function (jQuery, linkifyjs) {
	...
	var linkifyjs__default = /*#__PURE__*/_interopDefaultLegacy(linkifyjs);
	...
	*/
	      ...
	      case TXT_NODE:
	        {
	          ...
	          tokens = linkifyjs__default['default'].tokenize(str);
	...
	function linkifyElement(element, opts) {
	  ...
	  opts = new linkifyjs__default['default'].Options(opts);
	...
	linkifyElement.normalize = function (opts) {
	  return new linkifyjs__default['default'].Options(opts);
	};
