...
if($previllages == "admin"){
	...
	$sql = "SELECT * FROM students WHERE roll_no = '$edit'";
	...
	$roll_no = $fetched['roll_no'];
	$f_name = $fetched['father_name'];
...
<?php 
			...
			$error.="Error: ".mysqli_error($conn)."<br>";
				...
				$sql = "UPDATE students SET roll_no = '$roll_no' WHERE roll_no = '$edit';";
				$sql.= "UPDATE students SET name = '$user_name' WHERE roll_no = '$edit';";
				$sql.= "UPDATE students SET father_name = '$f_name' WHERE roll_no = '$edit';";
				$sql.= "UPDATE students SET password = '$password' WHERE roll_no = '$edit';";
				$sql.= "UPDATE students SET gender = '$gender' WHERE roll_no = '$edit';";
				$sql.= "UPDATE students SET classs = '$classs' WHERE roll_no = '$edit';";
				$sql.= "UPDATE students SET section = '$section' WHERE roll_no = '$edit';";
...
<body>
  ...
  <div class="text-center">
	...
	<h5 id="typing" class="text-center text-info font-50px aniview-2 slow" data-av-animation="pulse">
		<span class="border-bottom-info">Edit Student</span>&nbsp;
	</h5>
  ...
  <input type="text" id="user_name" value="<?php echo $fetched['name'] ?>" class="form-control" placeholder="Name" autocomplete="off" id="img-brand" name="user_name" required>
  <br>
  ...
  <button class="btn btn-lg btn-outline-success btnCustom btn-block" type="submit" name="submit">UPDATE</button>
